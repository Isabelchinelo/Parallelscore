...
public class Constants {
	...
	public static String SUITE1_XL_PATH = System.getProperty("user.dir") + "/src/test/resources/testdata/AdminSuite.xlsx";
	public static String SUITE2_XL_PATH = System.getProperty("user.dir") + "/src/test/resources/testdata/FrontDeskSuite.xlsx";
